...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VER_RES_MAX, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_DPI, 148);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_UUID_CNT, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_COLOR_PRIMARY_RED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_COLOR_SECONDARY_RED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_FONT_SMALL_UNSCII_8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_FONT_NORMAL_UNSCII_8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_FONT_SUBTITLE_UNSCII_8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_DEFAULT_FONT_TITLE_UNSCII_8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_FONT_UNSCII_8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_TXT_ENC_ASCII, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_USE_LINE, 1);
